...
__laps_model = 'autodetect/data/models/laps.model.json'
__laps_weights = 'autodetect/data/models/laps.weights.h5'
...
def laps_detector(img):
	...
	contours, _1 = cv2.findContours(mask,cv2.RETR_EXTERNAL,
